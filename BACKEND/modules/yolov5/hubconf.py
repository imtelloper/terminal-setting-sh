...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from modules.yolov5.models.common import AutoShape, DetectMultiBackend
    from modules.yolov5.models.yolo import Model
    from modules.yolov5.utils.downloads import attempt_download
    from modules.yolov5.utils.general import LOGGER, check_requirements, intersect_dicts, logging
