...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from modules.yolo.models.common import AutoShape, DetectMultiBackend
    from modules.yolo.models.yolo import Model
    from modules.yolo.utils.downloads import attempt_download
    from modules.yolo.utils.general import LOGGER, check_requirements, intersect_dicts, logging
