...
mongodbUri = "mongodb://interx:interx12!@192.168.0.3:27017/interx"
...
print('http://192.168.0.3:81/api/stream/area/' + sensingGroup)

vcap = cv2.VideoCapture('http://192.168.0.3:81/api/stream/area/' + sensingGroup)
...
while (setVcapBool):
    ...
    if vcap.read()[0] == False:
        ...
        vcap = cv2.VideoCapture(
            'http://192.168.0.3:81/api/stream/area/' + sensingGroup)
        print(vcap.read()[0])
    else:
        setVcapBool = False
